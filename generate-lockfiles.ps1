...
del pnpm-lock.yaml, pnpm-lock-v5.4.yaml, pnpm-lock-v6.0.yaml, pnpm-lock-v9.0.yaml -Force -ErrorAction SilentlyContinue
...
move -Force pnpm-lock.yaml pnpm-lock-v5.4.yaml
...
move -Force pnpm-lock.yaml pnpm-lock-v9.0.yaml
...
move -Force pnpm-lock.yaml pnpm-lock-v6.0.yaml
